module SdpDB
  ...
  PhaseDB = {
    # name => [phase_id, propal_id]
	  'Bundle Management'                                    =>[50913,47172], #
    'Continuous Improvement'                               =>[50915,47166], #
    'Quality Assurance'                                    =>[50914,47173], #
    'Provisions'			                                     =>[50916,47174], #
    # name => [phase_id, propal_id]
    ...
    "2016-WP1.1.1 - Quality Gate"                             => [50875,47167],
    "2016-WP1.1.2 - Milestone - CCB review preparation"       => [50876,47167],
    "2016-WP1.1.3 - Process Adherence Measurement"            => [50877,47167],
    "2016-WP1.1.4 - Quality Status of a Project"              => [50878,47167],
    "2016-WP1.1.5 - Quality of Product Document"              => [50879,47167],
    "2016-WP1.1.6 - Quality of the Configuration Management"  => [50880,47167],
    "2016-WP1.1.7 - Quality of the Code Static Review"        => [50881,47167],
    "2016-WP1.1.8 - Quality of the Test Dossier"              => [50882,47167],
    "2016-WP1.2.1 - Quality Assurance M3-M5 - G2-G5 - sM3-sM5"=> [50883,47167],
    "2016-WP1.2.2 - Quality Assurance M5-M10 - G5-G6"         => [50884,47167],
    "2016-WP1.2.3 - Quality Assurance Post M10 - Post G6"     => [50885,47167],
    "2016-WP1.2.4 - Quality Assurance Agile Sprint 0"         => [50886,47167],
    "2016-WP1.2.5 - Quality Assurance Agile Sprints"          => [50887,47167],
    "2016-WP1.3.1 - DW-PLM Quality Plan"                      => [50888,47167],
    "2016-WP1.3.2 - Support KPI and Reporting"                => [50889,47167],
    "2016-WP1.3.3 - PSU (GPP LBIP Suite)"                     => [50890,47167],
    "2016-WP1.3.4 - LL"                                       => [50891,47167],
    "2016-WP1.3.5 - E-M&T Referential Change Management"      => [50892,47167],
    "2016-WP2.1 - Business Process Layout"                    => [50893,47168],
    "2016-WP2.2 - Functional Layout (Use Cases)"              => [50894,47168],
    "2016-WP2.3 - Information Layout (Data Model)"            => [50895,47168],
    "2016-WP2.4 - Modeling Update"                            => [50896,47168],
    "2016-WP3.1.1 - Root Cause Analysis (Classic Approach)"   => [50897,47169],
    "2016-WP3.1.2 - Root Cause Analysis (Seminar Approach)"   => [50898,47169],
    "2016-WP3.2 - Action Plan of the Root Cause Analysis"     => [50899,47169],
    "2016-WP4.1 - Coaching Project Plan"                      => [50900,47170],
    "2016-WP4.2 - Coaching BRD"                               => [50901,47170],
    "2016-WP4.3 - Coaching V&V"                               => [50902,47170],
    "2016-WP4.4 - Coaching CMP"                               => [50903,47170],
    "2016-WP4.5 - Coaching HLR"                               => [50904,47170],
    "2016-WP4.6 - Coaching Use Case"                          => [50905,47170],
    "2016-WP4.7.1 - Diagnosis and Project Launch"             => [50906,47170],
    "2016-WP4.7.2 - Sprint 0 Support"                         => [50907,47170],
    "2016-WP4.7.3 - Sprint Coaching"                          => [50908,47170],
    "2016-WP4.8 - Risk Management"                            => [50909,47170],
    "2016-WP4.9 - E-M&T Referential"                          => [50910,47170],
    "2016-WP5.1 - Light Expertise"                            => [50911,47171],
    "2016-WP5.2 - Complete Expertise"                         => [50912,47171]
  }
