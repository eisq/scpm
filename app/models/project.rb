...
class Project < ActiveRecord::Base
  ...
  def create_milestone(lifecycle_milestone)
    ...
    milestones.create(:project_id=>self.id, :name=>lifecycle_milestone.milestone_name.title, :index_order=>lifecycle_milestone.index_order, :comments=>rv[0], :status=>(rv[1] == 0 ? -1 : 0))
  end
