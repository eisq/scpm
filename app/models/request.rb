class Request < ActiveRecord::Base
  ...
  "2016-WP1.3.3 - PSU (GPP LBIP Suite)"                             => "2016 PSU",
  "2016-WP1.3.4 - LL"                                               => "2016 LL",
  "2016-WP1.3.5 - E-M&T Referential Change Management"              => "2016 E-M&T Referential Change Management",
  ...
  Wp_index_RFP2016 = {
    ...
    "2016-WP1.3.3 - PSU (GPP LBIP Suite)"                             => 15,
    "2016-WP1.3.4 - LL"                                               => 16,
    "2016-WP1.3.5 - E-M&T Referential Change Management"              => 17,
    "2016-WP2.1 - Business Process Layout"                            => 18,
    "2016-WP2.2 - Functional Layout (Use Cases)"                      => 19,
    "2016-WP2.3 - Information Layout (Data Model)"                    => 20,
    "2016-WP2.4 - Modeling Update"                                    => 21,
    "2016-WP3.1.1 - Root Cause Analysis (Classic Approach)"           => 22,
    "2016-WP3.1.2 - Root Cause Analysis (Seminar Approach)"           => 23,
    "2016-WP3.2 - Action Plan of the Root Cause Analysis"             => 24,
    "2016-WP4.1 - Coaching Project Plan"                              => 25,
    "2016-WP4.2 - Coaching BRD"                                       => 26,
    "2016-WP4.3 - Coaching V&V"                                       => 27,
    "2016-WP4.4 - Coaching CMP"                                       => 28,
    "2016-WP4.5 - Coaching HLR"                                       => 29,
    "2016-WP4.6 - Coaching Use Case"                                  => 30,
    "2016-WP4.7.1 - Diagnosis and Project Launch"                     => 31,
    "2016-WP4.7.2 - Sprint 0 Support"                                 => 32,
    "2016-WP4.7.3 - Sprint Coaching"                                  => 33,
    "2016-WP4.8 - Risk Management"                                    => 34,
    "2016-WP4.9 - E-M&T Referential"                                  => 35,
    "2016-WP5.1 - Light Expertise"                                    => 36,
    "2016-WP5.2 - Complete Expertise"                                 => 37
  }
 ...
 # reminder: minus 10% for operational meetings
  ...
  def wp_index_RFP2016(wp, cv)
    rv = Wp_index_RFP2016[wp+(cv=="Yes" ? "CV":"")]
    raise "no workpackage #{wp}" if not rv
    rv
  end
