...
module LessonsLearntProject
  ...
  def self.generate_file_header(pm, qwr, coc, suite, project)
    return [[PM_HEADER, pm],[QWR_HEADER, qwr],[COC_HEADER, coc],[SUITE_HEADER, suite],[PROJECT_HEADER, project]]
  end
